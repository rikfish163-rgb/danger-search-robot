...
class GraphNBVStageB3:
    ...
    def __init__(self) -> None:
        ...
        self.initial_state = (
            ...
            if self.initial_forward_enabled
            else "DISABLED"
        )
        self.initial_complete = not self.initial_forward_enabled
        ...
        rospy.loginfo(
            "[graph_nbv] Stage B.3 started dry_run=%s "
            "initial_forward=%s initial_forward_only=%s",
            self.dry_run,
