...
export FLOOR_STATE_FILE="${FLOOR_STATE_FILE:-$ROS1_RUNTIME_STATE_DIR/floor_state.json}"
export FLOOR_ANCHOR_FILE="${FLOOR_ANCHOR_FILE:-$ROS1_RUNTIME_STATE_DIR/floor_transition_anchor.json}"
